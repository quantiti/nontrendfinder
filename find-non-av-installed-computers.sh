...
masscan $1 -p135,137,139,445,3389 --excludefile exclude.txt --excludefile managed.txt| cut -d' ' -f6 > "445-$2.txt"
#scan port 64000 to detect computers installed trend v14
masscan $1 -p64000 --excludefile managed.txt| cut -d' ' -f6 > "64000-$2.txt"
#scan port 17774 to detect computers installed trend v12
masscan $1 -p17774 --excludefile managed.txt| cut -d' ' -f6 >> "64000-$2.txt"
